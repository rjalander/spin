...
/* 
PipelineControllerApiService Re-order a waiting pipeline execution
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param executionId executionId
 * @param reorderAction reorderAction


*/
func (a *PipelineControllerApiService) ReorderPipelineUsingPUT(ctx context.Context, executionId string, reorderAction string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("PUT")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/pipelines/{executionId}/reorder?reorderAction={reorderAction}"
	localVarPath = strings.Replace(localVarPath, "{"+"executionId"+"}", fmt.Sprintf("%v", executionId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"reorderAction"+"}", fmt.Sprintf("%v", reorderAction), -1)
